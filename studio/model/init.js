...
function CreateTable(table) {
    ...
    let rc = fs.WriteFile(filename.slice(0, -4) + "default.json", JSON.stringify(newTable));
}
/**
...
function CreateForm(form) {
    ...
    const rc = fs.WriteFile(filename.slice(0, -4) + "default.json", JSON.stringify(newForm));
}
/**
